...
(function() {
  ...
  function showUIButtons() {
    document.querySelectorAll('.theme-toggle, .settings-toggle, .camera-btn').forEach(function(btn) {
  ...
  // ===== АВТОПЕРЕЗАГРУЗКА ЗА 2 МИНУТЫ ДО ИСТЕЧЕНИЯ КЛЮЧА =====
  ...
  function startExpiryWatcher() {
    ...
    setInterval(function() {
      ...
      try {
        ...
        // За 2 минуты до истечения (120000 мс) — перезагружаем
